...
public class ConfiguredRangeSupplier extends OneShotSupplier {
    public static class Config extends ConfigurationBase {
        ...
        public static class Keys {
            public static final String RANGE_BOTTOM = "supplier.range.bottom";
            public static final String RANGE_TOP = "supplier.range.top";
        }
    ...
    public static ConfiguredRangeSupplier open(Configuration config) {
        ...
        return new ConfiguredRangeSupplier(OneShotSupplier.of(() ->
