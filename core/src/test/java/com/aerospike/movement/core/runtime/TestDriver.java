...
import static com.aerospike.movement.config.core.ConfigurationBase.Keys.WORK_CHUNK_DRIVER;
...
public class TestDriver {
    ...
    public void testWorkChunkDriver() {
        ...
        Configuration config = new MapConfiguration(new HashMap<>() {{
            ...
            put(ConfigurationBase.Keys.PHASE, Runtime.PHASE.ONE.name());
            put(SuppliedWorkChunkDriver.Config.Keys.RANGE_BOTTOM, 0);
            put(SuppliedWorkChunkDriver.Config.Keys.RANGE_TOP, 100);
    ...
    public void testWorkChunkDriverConcurrent() throws Exception {
        ...
        Configuration config = new MapConfiguration(new HashMap<>() {{
            ...
            put(ConfigurationBase.Keys.PHASE, Runtime.PHASE.ONE.name());
            put(SuppliedWorkChunkDriver.Config.Keys.RANGE_BOTTOM, 0);
            put(SuppliedWorkChunkDriver.Config.Keys.RANGE_TOP, 100_000);
            put(SuppliedWorkChunkDriver.Config.Keys.ITERATOR_SUPPLIER, ConfiguredRangeSupplier.class.getName());
        }});
        SuppliedWorkChunkDriver driver = (SuppliedWorkChunkDriver) SuppliedWorkChunkDriver.open(config);
