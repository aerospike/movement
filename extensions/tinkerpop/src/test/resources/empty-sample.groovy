import com.aerospike.movement.cluster.tinkerpop.ClusterPlugin
...
uri = ((org.apache.tinkerpop.gremlin.structure.Graph) graph).configuration().getProperty("cluster.uri")
new ClusterPlugin<>(URI.create(uri),graph).plugInto(graph)
