...
public class TinkerPopTraversalEncoder extends Loadable implements Encoder<Element> {
    ...
    public static TinkerPopTraversalEncoder open(final Configuration config) {
        ...
        return new TinkerPopTraversalEncoder(g, config);
    }
    ...
    public Element encodeEdge(final EmittedEdge edge) {
        ...
        try {
            ...
            throw errorHandler.handleFatalError(nse, "No such vertex found for edge: %s ", edge);
        }
    ...
    public Element encodeVertex(final EmittedVertex vertex) {
        ...
        try {
            ...
            throw errorHandler.handleFatalError(e, "Error encoding vertex: %s", vertex);
        }
    }
